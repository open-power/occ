...
const sensor_info_t G_sensor_info[]   =
{
  ...
  SENSOR_INFO_T_ENTRY(     WOFCOREWAKE, "n/a\0", AMEC_SENSOR_TYPE_GENERIC,  AMEC_SENSOR_LOC_OCC, AMEC_SENSOR_NONUM,   AMEEFP_2MS_IN_HZ,   AMEFP(  1, 0)  ),
  SENSOR_INFO_T_ENTRY(    WOFCEFFRATIO, "n/a\0", AMEC_SENSOR_TYPE_GENERIC,  AMEC_SENSOR_LOC_OCC, AMEC_SENSOR_NONUM,   AMEEFP_2MS_IN_HZ,   AMEFP(  1, 0)  ),
  SENSOR_INFO_T_ENTRY(    WOF250USVDDS, "mV\0",  AMEC_SENSOR_TYPE_VOLTAGE,  AMEC_SENSOR_LOC_VRM, AMEC_SENSOR_NONUM,   AMEEFP_2MS_IN_HZ,   AMEFP(  1,-1)  ),
  ...
  SENS_CORE_ENTRY_SET(      VOLT2MSP0C,  "mV\0", AMEC_SENSOR_TYPE_VOLTAGE, AMEC_SENSOR_LOC_CORE, AMEC_SENSOR_NONUM,   AMEEFP_2MS_IN_HZ,   AMEFP(  1,-1)  ),
