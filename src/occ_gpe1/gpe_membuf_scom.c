                      ...
                      uint32_t *o_oci_addr)
{
    ...
    pbaslvctl_setup(&(i_config->scomParms));
                      ...
                      MemBufScomParms_t* i_parms)
{
    ...
    {
        PK_TRACE_DBG("gpe_inband_scom. cmdtype %d",i_parms->scomList[i].commandType);
