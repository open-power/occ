...
#define INT_FLAG_ENABLE_EVERY_TICK_TEMP_DVFS 0x00000100  // enable processor temperature DVFS to be every tick
#define INT_FLAG_DISABLE_OC_ACTUATION        0x00000800  // Disable OC protection
