...
occSysConfigData_t G_sysConfigData =
{
    ...
    .apss_adc_map =   {
        ...
        .dcm_vpcie[0]        = SYSCFG_INVALID_ADC_CHAN,
        .dcm_vpcie[1]        = SYSCFG_INVALID_ADC_CHAN,
        .dcm_vpcie[2]        = SYSCFG_INVALID_ADC_CHAN,
        .dcm_vpcie[3]        = SYSCFG_INVALID_ADC_CHAN,
        .dcm_vio[0]          = SYSCFG_INVALID_ADC_CHAN,
        .dcm_vio[1]          = SYSCFG_INVALID_ADC_CHAN,
        .dcm_vio[2]          = SYSCFG_INVALID_ADC_CHAN,
        .dcm_vio[3]          = SYSCFG_INVALID_ADC_CHAN,
        .avdd_total          = SYSCFG_INVALID_ADC_CHAN,
    },
