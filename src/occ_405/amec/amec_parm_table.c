...
amec_parm_t g_amec_parm_list[] = {
    ...
    AMEC_PARM_UINT32(PARM_IAC_VDD, "iac_vdd", &g_amec_sys.wof.iac_vdd_ua),
    AMEC_PARM_UINT32(PARM_IAC_VCS, "iac_vcs", &g_amec_sys.wof.iac_vcs_ua),
    AMEC_PARM_UINT32(PARM_IAC_TDP_VDD, "iac_tdp_vdd_10ma", &g_amec_sys.wof.iac_tdp_vdd_10ma),
