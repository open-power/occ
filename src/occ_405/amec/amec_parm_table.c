...
amec_parm_t g_amec_parm_list[] = {
    ...
    AMEC_PARM_UINT32(PARM_VOLT_VCS_SENSE, "voltvcssense", &g_amec_sys.wof.voltvcssense_sensor),
    AMEC_PARM_UINT16_ARRAY(PARM_TEMPPROCTHERMC, "tempprocthrmc", &g_amec_sys.wof.tempprocthrmc, MAX_NUM_CORES),
    AMEC_PARM_UINT16(PARM_TEMP_RT_AVG, "tempRTavg", &g_amec_sys.wof.tempRT_sensor),
    ...
    AMEC_PARM_UINT32(PARM_IDC_VCS, "idc_vcs", &g_amec_sys.wof.idc_vcs),
