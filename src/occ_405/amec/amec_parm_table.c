...
amec_parm_t g_amec_parm_list[] = {
    ...
    AMEC_PARM_UINT32(PARM_IDC_VDD, "idc_vdd", &g_amec_sys.wof.iddq_100ua),
    AMEC_PARM_UINT32(PARM_IDC_VCS, "idc_vcs", &g_amec_sys.wof.icsq_100ua),
    AMEC_PARM_UINT32(PARM_IAC_VDD, "iac_vdd", &g_amec_sys.wof.iac_vdd_100ua),
    AMEC_PARM_UINT32(PARM_IAC_VCS, "iac_vcs", &g_amec_sys.wof.iac_vcs_100ua),
    AMEC_PARM_UINT32(PARM_IAC_TDP_VDD, "iac_tdp_vdd_10ma", &g_amec_sys.wof.iac_tdp_vdd_100ua),
    AMEC_PARM_UINT16(PARM_V_RATIO, "Vratio", &g_amec_sys.wof.v_ratio_vdd),
    AMEC_PARM_UINT8(PARM_F_CLIP_PS, "Fclip_PS", &g_amec_sys.wof.f_clip_ps),
    AMEC_PARM_UINT32(PARM_CEFF_RATIO_VDD_N, "ceffRatioVdd_n", &g_amec_sys.wof.ceff_ratio_vdd_numerator),
    AMEC_PARM_UINT32(PARM_CEFF_RATIO_VDD_D, "ceffRatioVdd_d", &g_amec_sys.wof.ceff_ratio_vdd_denominator),
    AMEC_PARM_UINT32(PARM_CEFF_RATIO_VDD, "ceff_ratio_vdd", &g_amec_sys.wof.ceff_ratio_vdd),
    AMEC_PARM_UINT32(PARM_CEFF_RATIO_VCS_N, "ceffRatioVcs_n", &g_amec_sys.wof.ceff_ratio_vcs_numerator),
    AMEC_PARM_UINT32(PARM_CEFF_RATIO_VCS_D, "ceffRatioVcs_d", &g_amec_sys.wof.ceff_ratio_vcs_denominator),
    ...
    AMEC_PARM_UINT32(PARM_VDD_RATIO, "vddRatio", &g_amec_sys.wof.c_ratio_iac_tdp_vddp1ma),
    AMEC_PARM_UINT32(PARM_CEFF_RATIO_FREQ, "ceffRatioFreq", &g_amec_sys.wof.avg_freq_mhz),
    AMEC_PARM_UINT32(PARM_VCS_RATIO, "vcsRatio", &g_amec_sys.wof.c_ratio_iac_tdp_vcsp1ma),
