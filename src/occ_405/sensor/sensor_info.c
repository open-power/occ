...
const sensor_info_t G_sensor_info[]   =
{
  ...
  SENSOR_INFO_T_ENTRY(         PWRMEM,   "W\0",   AMEC_SENSOR_TYPE_POWER,  AMEC_SENSOR_LOC_MEM, AMEC_SENSOR_NONUM,      AMEEFP_EVERY_16TH_TICK_HZ, AMEFP(  1, 0)  ),
  ...
  SENS_MEMC_ENTRY_SET(     MEMUTILM,   "%\0",   AMEC_SENSOR_TYPE_UTIL,  AMEC_SENSOR_LOC_MEM, AMEC_SENSOR_NONUM,   AMEEFP_EVERY_8TH_TICK_HZ, AMEFP(  1, -2) ),
  SENS_MEMC_ENTRY_SET(     MEMPWRM,    "W\0",   AMEC_SENSOR_TYPE_POWER, AMEC_SENSOR_LOC_MEM, AMEC_SENSOR_NONUM,   AMEEFP_EVERY_128TH_TICK_HZ, AMEFP(  1, -2)  ),
  ...
  SENSOR_INFO_T_ENTRY(   MMA_ON_AVG,    "%\0",   AMEC_SENSOR_TYPE_WOF,  AMEC_SENSOR_LOC_PROC, AMEC_SENSOR_NONUM, AMEEFP_1S_IN_HZ,      AMEFP(  1, 0)  ),
  ...
  SENSOR_INFO_T_ENTRY(   DIRTY_CURRENT, "A\0", AMEC_SENSOR_TYPE_CURRENT, AMEC_SENSOR_LOC_PROC, AMEC_SENSOR_NONUM, AMEEFP_EVERY_TICK_HZ, AMEFP( 1,-2)  ),
};
