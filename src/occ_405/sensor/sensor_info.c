...
const sensor_info_t G_sensor_info[]   =
{
  ...
  SENSOR_INFO_T_ENTRY(     timer2dur,  "us\0",    AMEC_SENSOR_TYPE_TIME,  AMEC_SENSOR_LOC_OCC, AMEC_SENSOR_NONUM, AMEEFP_EVERY_TICK_HZ, AMEFP(  1, 0)  ),
  ...
  SENSOR_INFO_T_ENTRY(   VOLTVIOSENSE,  "mV\0", AMEC_SENSOR_TYPE_VOLTAGE, AMEC_SENSOR_LOC_PROC, AMEC_SENSOR_NONUM,  AMEEFP_EVERY_4TH_TICK_HZ, AMEFP(  1, -1)  ),
  ...
  SENSOR_INFO_T_ENTRY(         PWRVIO,   "W\0",   AMEC_SENSOR_TYPE_POWER, AMEC_SENSOR_LOC_PROC, AMEC_SENSOR_NONUM,  AMEEFP_EVERY_2ND_TICK_HZ, AMEFP(  1, 0)  ),
  ...
  SENSOR_INFO_T_ENTRY(        VOLTVIO, "mV\0", AMEC_SENSOR_TYPE_VOLTAGE,  AMEC_SENSOR_LOC_VRM, AMEC_SENSOR_NONUM, AMEEFP_EVERY_4TH_TICK_HZ, AMEFP(  1, -1)  ),
  ...
  SENSOR_INFO_T_ENTRY(   VRATIO,        " \0",   AMEC_SENSOR_TYPE_WOF,  AMEC_SENSOR_LOC_PROC, AMEC_SENSOR_NONUM, AMEEFP_EVERY_TICK_HZ, AMEFP(  1, 0)  ),
